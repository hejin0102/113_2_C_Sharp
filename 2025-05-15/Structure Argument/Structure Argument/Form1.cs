...
namespace Structure_Argument
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void auto1Button_Click(object sender, EventArgs e)
        {
            ...
            sportsCar.make = "Chevy Corvette"; // 廠牌
            sportsCar.year = 1970;             // 年份
            sportsCar.mileage = 50000.0;       // 里程數
        ...
        private void auto2Button_Click(object sender, EventArgs e)
        {
            ...
            pickupTruck.make = "Ford Ranger";  // 廠牌
            pickupTruck.year = 1985;           // 年份
            pickupTruck.mileage = 75000.0;     // 里程數
        ...
        private void auto3Button_Click(object sender, EventArgs e)
        {
            ...
            sedan.make = "Honda Accord";   // 廠牌
            sedan.year = 2000;             // 年份
            sedan.mileage = 80000.0;       // 里程數
